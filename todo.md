...
You are attached to a Microsoft Fabric Spark notebook and are going to assist me writing Spark/Jupyter code.  I have already attached a lakehouse to this notebook.  It has a table called dbo.marketing_surveys.  Show me 5 rows from that table.  

Show your work in #file:Notebook_13.ipynb

You have permission to run all cells in this notebook.
...
You are attached to a Microsoft Fabric Spark notebook and are going to assist me writing Spark/Jupyter code.  I have already attached a lakehouse to this notebook.  It has a table called dbo.drillpressdata.  Show me 5 rows from that table.  

Show your work in #file:Notebook_14.ipynb
