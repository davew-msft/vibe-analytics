...
[Here is the notebook with all of the prompts inline](./Notebook-with-prompts.ipynb)
...
back out. This mirrors how real analysis feels — and it's far more memorable than a dashboard.
...
> the "data" is confirming a story we already believed. Downtime reason
...
### Step 3 — Bring in the data the dashboard ignored
...
> *One* root cause — over-blended, contaminated regrind — drove **all three**
